                            ...
                            <div class="col-3 ">
                                ...
                                <select class="form-control" name="companies_contacts_id" id="companies_contacts_id_dropdown">
                                    @foreach($companiesContacts as $value)
                                        <option value="{{ $value->id }}" {{ (old('companies_contacts_id') == $value->id || (isset($model) && $model->id == $value->id)) ? 'selected' : '' }}>{{ $value->getFormattedName() }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-3 ">
                                ...
                                <select class="form-control" name="deals_statuses_id" id="deals_statuses_id_dropdown">
                                    @foreach($dealsStatuses as $value)
                                        <option value="{{ $value->id }}" {{ (old('deals_statuses_id') == $value->id || (isset($model) && $model->id == $value->id)) ? 'selected' : '' }}>{{ $value->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-3 ">
                                ...
                                <select class="form-control" name="deals_sources_id" id="deals_sources_id_dropdown">
                                    @foreach($dealsSources as $value)
                                        <option value="{{ $value->id }}" {{ (old('deals_sources_id') == $value->id || (isset($model) && $model->id == $value->id)) ? 'selected' : '' }}>{{ $value->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-2 mt-3">
                                ...
                                <select class="form-control" name="currency_id" id="currency_id_dropdown">
                                    @foreach($currencies as $value)
                                        <option value="{{ $value->id }}" {{ (old('currency_id') == $value->id || (isset($model) && $model->id == $value->id)) ? 'selected' : '' }}>{{ $value->name }}</option>
                                    @endforeach
                                </select>
