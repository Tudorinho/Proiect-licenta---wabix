...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">
            <a href="{{ route('users.create') }}" type="button" class="btn btn-success waves-effect waves-light" style="float: right">
    ...
    <table class="table table-bordered smart-datatable" id="smart-datatable">
        ...
        <tr>
			...
			<th>@lang('translation.fields.role')</th>
