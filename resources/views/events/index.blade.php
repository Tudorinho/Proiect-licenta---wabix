...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">
            <a href="{{ route('events.create') }}" type="button" class="btn btn-success waves-effect waves-light" style="float: right; margin-left: 5px;">
    ...
    <table class="table table-bordered smart-datatable" id="smart-datatable">
        ...
        <tr>
			...
			<th>@lang('translation.fields.eventsTypesId')</th>
