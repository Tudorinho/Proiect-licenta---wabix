...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">
            <a href="{{ route('wiki-articles.create') }}" type="button" class="btn btn-success waves-effect waves-light" style="float: right; margin-left: 5px;">
    ...
    <table class="table table-bordered smart-datatable" id="smart-datatable">
        ...
        <tr>
			...
			<th>@lang('translation.fields.wikiCategoriesId')</th>
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('.smart-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('wiki-articles.index') }}",
                lengthMenu: [
                    [100, 250, 500],
                    [100, 250, 500]
                ],
