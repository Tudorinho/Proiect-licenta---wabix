...
@section('title')
    @lang('translation.languages.editLanguage')
@endsection
                    ...
                    <form action="{{ route('languages.update', ['id'=>$language->id]) }}" method="POST">
						...
						<div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="@lang('translation.languages.languageName')" value="{{ old('name', $language?->name ?? '') }}">
