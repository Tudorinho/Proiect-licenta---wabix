...
@section('title')
    @lang('translation.taskStatusChange.tasksStatusesChanges')
@endsection
...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">
            <a href="{{ route('tasks-statuses-changes.create') }}" type="button" class="btn btn-success waves-effect waves-light" style="float: right; margin-left: 5px;">
    ...
    <table class="table table-bordered smart-datatable" id="smart-datatable">
        ...
        <tr>
			...
			<th>@lang('translation.fields.taskId')</th>
			<th>@lang('translation.fields.userId')</th>
			<th>@lang('translation.fields.fromStatus')</th>
			<th>@lang('translation.fields.toStatus')</th>
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('.smart-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('tasks-statuses-changes.index') }}",
                lengthMenu: [
                    [100, 250, 500],
                    [100, 250, 500]
                ],
