...
@section('title')
    @lang('translation.wikiCategory.editWikiCategory')
@endsection
...
@section('content')
    @component('components.breadcrumb')
        @slot('li_1')
            <a href="{{ route('wiki-categories.index') }}">@lang('translation.wikiCategory.wikiCategories')</a>
        @endslot
        @slot('title')
            @lang('translation.wikiCategory.addWikiCategory')
        @endslot
    @endcomponent
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('wiki-categories.update', ['id' => $model->id]) }}" method="POST">
                        @method('PUT')
                        {{ csrf_field() }}
