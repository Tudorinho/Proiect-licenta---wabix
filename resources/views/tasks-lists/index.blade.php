...
@section('title')
    @lang('translation.taskList.tasksLists')
@endsection
...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">
            <a href="{{ route('tasks-lists.create') }}" type="button" class="btn btn-success waves-effect waves-light" style="float: right; margin-left: 5px;">
