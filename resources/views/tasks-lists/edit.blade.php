...
@section('title')
    @lang('translation.taskList.addTaskList')
@endsection
...
@section('content')
    @component('components.breadcrumb')
        @slot('li_1')
            <a href="{{ route('tasks-lists.index') }}">@lang('translation.taskList.tasksLists')</a>
        @endslot
        @slot('title')
            @lang('translation.taskList.addTaskList')
        @endslot
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('tasks-lists.update', ['id' => $model->id]) }}" method="POST">
                        @method('PUT')
                        {{ csrf_field() }}
