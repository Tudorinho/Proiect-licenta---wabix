...
@section('title')
    @lang('translation.coldEmailingCredentials.editColdEmailingCredentials')
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('cold-emailing-credentials.update', ['id' => $model->id]) }}" method="POST">
                        @method('PUT')
                        {{ csrf_field() }}
						...
						<div class="row">
                            ...
                            <div class="col-4 ">
                                ...
                                <input type="text" class="form-control" name="password" placeholder="@lang('translation.fields.password')">
