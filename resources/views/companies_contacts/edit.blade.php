...
@section('content')
    @component('components.breadcrumb')
        @slot('li_1')
            <a href="{{ route('companies_contacts.index') }}">@lang('translation.companyContact.companiesContacts')</a>
        @endslot
        @slot('title')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('companies_contacts.update', ['id' => $model->id]) }}" method="POST">
                        @method('PUT')
                        {{ csrf_field() }}
