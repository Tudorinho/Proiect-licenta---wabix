...
@section('title')
    @lang('translation.coldCallingListsContacts.coldCallingListsContacts')
@endsection
...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">
            <a href="{{ route('cold-calling-lists-contacts.create') }}" type="button" class="btn btn-success waves-effect waves-light" style="float: right; margin-left: 5px;">
                <i class="bx bx-plus font-size-16 align-middle me-2"></i> @lang('translation.buttons.add')
            </a>
            @include('cold-calling-lists-contacts.partials.import')
        </div>
    </div>
    ...
    <table class="table table-bordered smart-datatable" id="smart-datatable">
        ...
        <tr>
			...
			<th>@lang('translation.fields.coldCallingListsId')</th>
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('.smart-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('cold-calling-lists-contacts.index') }}",
                lengthMenu: [
                    [100, 250, 500],
                    [100, 250, 500]
                ],
