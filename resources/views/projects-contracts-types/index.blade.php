...
@section('title')
    @lang('translation.projectContractType.projectsContractsTypes')
@endsection
...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">
            <a href="{{ route('projects-contracts-types.create') }}" type="button" class="btn btn-success waves-effect waves-light" style="float: right; margin-left: 5px;">
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('.smart-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('projects-contracts-types.index') }}",
                columns: [
                    {
                        data: 'DT_RowIndex',
                        name: 'No',
