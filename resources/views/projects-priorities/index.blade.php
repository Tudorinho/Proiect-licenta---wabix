...
@section('title')
    @lang('translation.projectPriority.projectsPriorities')
@endsection
...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">
            <a href="{{ route('projects-priorities.create') }}" type="button" class="btn btn-success waves-effect waves-light" style="float: right; margin-left: 5px;">
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('.smart-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('projects-priorities.index') }}",
                columns: [
                    {
                        data: 'DT_RowIndex',
                        name: 'No',
