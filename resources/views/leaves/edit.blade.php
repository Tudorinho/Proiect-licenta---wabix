...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('leaves.update', ['id' => $model->id]) }}" method="POST">
                        @method('PUT')
                        {{ csrf_field() }}
						...
						<div class="row">
                            <div class="col-3 #marginTop">
                                ...
                                <select class="form-control" name="employee_id" id="employee_id_dropdown" readonly="readonly">
                                    @foreach($employees as $value)
                                        <option value="{{ $value->id }}" {{ (old('employee_id') == $value->id || (isset($model) && $model->employee_id == $value->id)) ? 'selected' : '' }}>{{ $value->first_name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-3 #marginTop">
                                ...
                                <input disabled="disabled" type="text" class="form-control" id="start_date_datepicker" name="start_date" placeholder="@lang('translation.fields.startDate')" value="{{ old('start_date', $model?->start_date ?? '') }}">
                            ...
                            <div class="col-3 mt-3">
                                ...
                                <input disabled="disabled" type="text" class="form-control" id="end_date_datepicker" name="end_date" placeholder="@lang('translation.fields.endDate')" value="{{ old('end_date', $model?->end_date ?? '') }}">
